...
// ─── ProjectCard ─────────────────────────────────────────────────────────────
// FIX: was 40+ animated elements per card (280+ total for 7 cards).
// Now: 1 entrance animation per card + CSS transitions for hover effects.
const ProjectCard = memo(({ project, index }) => {
  ...
  return (
    ...
    >
      {/* Static background glow — no animation, just CSS */}
      <div
      ...
      <div className={`w-full max-w-7xl mx-auto flex flex-col ${
        ...
        <div className="w-full lg:w-[55%] relative group">
          <div className="relative">
            {/* Glowing border — CSS only, no JS animation */}
            ...
            <div className="relative overflow-hidden rounded-3xl shadow-2xl bg-secondary border border-teal-400/10">
              ...
              {/* Quick Action Buttons — CSS transition only */}
            ...
            {/* Static decorative square — no rotation animation */}
            <div
        ...
        <div className="w-full lg:w-[45%] space-y-6 sm:space-y-8">
          ...
          {/* Tech Stack — CSS hover only, NO individual animations */}
          <div>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {project.tech.map((tech) => (
                <span
                  key={tech}
                  className="relative px-4 py-2 rounded-xl bg-secondary border border-teal-400/20 text-gray-300 font-medium text-sm sm:text-base shadow-lg
                             hover:border-teal-400/50 hover:text-white hover:shadow-teal-400/20 hover:shadow-xl
...
// ─── Background Particles — reduced from 30 → 8 desktop, animation simplified ─
