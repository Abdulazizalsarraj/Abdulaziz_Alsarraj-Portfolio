...
// ─── Mobile Hero Visual ──────────────────────────────────────────────────────
// FIX: now respects reducedMotion for all 3 ring animations
...
// ─── FloatingParticles ───────────────────────────────────────────────────────
// FIX: reduced from 12 desktop / 5 mobile → 6 / 3. Simplified animation (y only).
...
const Home = () => {
  ...
  return (
    <div className="mt-12 relative bg-primary transition-colors duration-300">
      ...
      {/* Show skeleton until Three.js is ready */}
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center order-1 lg:order-2">
            ...
            >
              ...
              {/* Rotating Border — kept as it's the main visual identity */}
              <motion.div
              ...
              <div className="relative w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
                ...
                {/* FIX: Decorative badges — CSS animation instead of Framer Motion infinite */}
                <div
          ...
          >
            ...
            {/* FIX: CSS animation instead of Framer Motion infinite */}
        ...
        >
          {/* FIX: Removed infinite scale+rotate animation from this div */}
          <motion.div
