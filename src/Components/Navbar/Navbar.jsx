  ...
  return (
    <motion.nav
      className={`fixed top-0 w-full z-50 px-4 sm:px-6 md:px-8 lg:px-24 transition-all duration-300 ${
        isScrolled
          ? 'py-3 bg-[#0a0a0a]/95 shadow-2xl'
          : 'py-4 bg-[#0a0a0a]/90 shadow-lg'
      } border-b ${
        isScrolled
          ? 'border-teal-400/30'
          : 'border-teal-400/10'
    ...
    >
      ...
      >
        ...
        >
          <motion.div
            className="absolute -inset-2 bg-gradient-to-r from-teal-400/20 to-cyan-400/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          />
          <motion.img
            src={Logo}
            alt="Abdulaziz Alsarraj logo"
