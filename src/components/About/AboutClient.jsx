    ...
    <div ref={ref} className="relative w-full h-full flex items-center justify-center" aria-hidden="true">
      ...
      {[
        ...
        <motion.div
          ...
          style={{ background: `${accent}90`, translateX: badge.x, translateY: badge.y }}
...
const StatCard = memo(({ number, label, delay }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="text-center p-6 rounded-2xl bg-secondary/50 backdrop-blur-sm border border-teal-400/10"
    ...
    >
      ...
      <p className="text-[12px] sm:text-base text-gray-300 opacity-70 mt-2">{label}</p>
    </motion.div>
  );
});
...
const SkillCard = memo(({ skill, index, controls }) => (
  <motion.div
    className="group relative p-6 sm:p-8 rounded-3xl bg-secondary/80 border border-teal-400/10 flex flex-col items-center justify-center overflow-hidden"
    variants={{
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-br from-teal-400/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
    <img
      src={typeof skill.icon === 'string' ? skill.icon : skill.icon.src}
      alt={skill.name}
      width="64"
      height="64"
      ...
      loading="lazy"
    />
    <span className="text-xs sm:text-sm font-semibold text-gray-300 opacity-60 group-hover:opacity-100 transition-opacity duration-300 relative z-10">
      {skill.name}
    </span>
  </motion.div>
));
  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-screen flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 px-6 py-20 lg:px-16">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-teal-400/20 to-blue-500/20 rounded-3xl blur-3xl" />
          <div className="relative w-full h-full rounded-3xl overflow-hidden border border-teal-400/10 backdrop-blur-sm bg-white/5">
        ...
        >
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <span className="inline-block mt-5 px-4 py-2 rounded-full bg-teal-400/10 text-teal-400 text-sm font-semibold mb-4">
          ...
          <motion.p
            className="text-xl sm:text-2xl text-gray-300 opacity-80 font-light"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
          >
            Turning ideas into{' '}
            <span className="text-teal-400 font-semibold">intuitive</span>{' '}
            digital experiences
          </motion.p>

          <motion.div
            className="text-base sm:text-lg text-gray-300 opacity-75 leading-relaxed space-y-4"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <p>
              ...
              <span className="text-teal-400 font-medium">responsive interfaces</span>{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
          {SPECIALIZATIONS.map((item, index) => {
            ...
            return (
              <motion.div
                key={item.title}
                className="group relative p-8 rounded-3xl bg-secondary/80 border border-teal-400/10 overflow-hidden"
              ...
              >
                ...
                <p className="text-base sm:text-lg text-gray-400 leading-relaxed">{item.description}</p>
                <motion.div
      ...
      <div className="px-6 py-20 lg:px-16 relative">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-400">Technologies I work with daily</p>
        </motion.div>
